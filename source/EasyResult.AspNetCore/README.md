# EasyResult.AspNetCore

ASP.NET Core integration for [EasyResult](https://github.com/said1993/EasyResult).
...
```bash
dotnet add package Shl.EasyResult.AspNetCore --version 1.0.1-beta
```

Or via Package Manager:

```powershell
Install-Package Shl.EasyResult.AspNetCore -Version 1.0.1-beta
```
...
- [Shl.EasyResult](https://www.nuget.org/packages/Shl.EasyResult/) - Core Result pattern library
...
- Shl.EasyResult.FluentValidation - FluentValidation integration (coming soon)
