# SimpleResult.AspNetCore

ASP.NET Core integration for [SimpleResult](https://github.com/said1993/SimpleResult).
...
```bash
dotnet add package Shl.SimpleResult.AspNetCore --version 1.0.1-beta
```

Or via Package Manager:

```powershell
Install-Package Shl.SimpleResult.AspNetCore -Version 1.0.1-beta
```
...
- [Shl.SimpleResult](https://www.nuget.org/packages/Shl.SimpleResult/) - Core Result pattern library
...
- Shl.SimpleResult.FluentValidation - FluentValidation integration (coming soon)
