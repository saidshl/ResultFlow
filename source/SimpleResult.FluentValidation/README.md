# SimpleResult.FluentValidation

FluentValidation integration for [SimpleResult](https://github.com/said1993/SimpleResult).

This package provides seamless integration between [FluentValidation](https://fluentvalidation.net/) and SimpleResult, allowing you to convert validation results into `Result<T>` objects with comprehensive error handling.
...
```bash
dotnet add package Shl.SimpleResult.FluentValidation --version 1.0.1-beta
```

Or via Package Manager:

```powershell
Install-Package Shl.SimpleResult.FluentValidation -Version 1.0.1-beta
```
...
using SimpleResult.FluentValidation.Extensions;
...
// Use the validator with SimpleResult
...
When combined with `Shl.SimpleResult.AspNetCore`, validation errors automatically map to HTTP 422 responses:
...
- 📝 Report bugs by creating an [Issue](https://github.com/said1993/SimpleResult/issues)
...
- 🌐 Visit the [Repository](https://github.com/said1993/SimpleResult)

## 🔗 Related Packages

- [Shl.SimpleResult](https://www.nuget.org/packages/Shl.SimpleResult/) - Core library
- [Shl.SimpleResult.AspNetCore](https://www.nuget.org/packages/Shl.SimpleResult.AspNetCore/) - ASP.NET Core extensions
- Shl.SimpleResult.Logging - Structured logging integration (coming soon)
