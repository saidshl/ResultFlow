# EasyResult.FluentValidation

FluentValidation integration for [EasyResult](https://github.com/said1993/EasyResult).

This package provides seamless integration between [FluentValidation](https://fluentvalidation.net/) and EasyResult, allowing you to convert validation results into `Result<T>` objects with comprehensive error handling.
...
```bash
dotnet add package Shl.EasyResult.FluentValidation --version 1.0.1-beta
```

Or via Package Manager:

```powershell
Install-Package Shl.EasyResult.FluentValidation -Version 1.0.1-beta
```
...
using EasyResult.FluentValidation.Extensions;
...
// Use the validator with EasyResult
...
When combined with `Shl.EasyResult.AspNetCore`, validation errors automatically map to HTTP 422 responses:
...
- ?? Report bugs by creating an [Issue](https://github.com/said1993/EasyResult/issues)
- ?? Suggest features in [Discussions](https://github.com/said1993/EasyResult/discussions)
...
- ?? Visit the [Repository](https://github.com/said1993/EasyResult)

## ?? Related Packages

- [Shl.EasyResult](https://www.nuget.org/packages/Shl.EasyResult/) - Core library
- [Shl.EasyResult.AspNetCore](https://www.nuget.org/packages/Shl.EasyResult.AspNetCore/) - ASP.NET Core extensions
- Shl.EasyResult.Logging - Structured logging integration (coming soon)
